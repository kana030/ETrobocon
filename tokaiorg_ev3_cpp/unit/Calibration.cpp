...
// 定数宣言
const int Calibration::NUM_OF_GYRO_CALIBRATION =  250; // ★キャリブレーション演習修正箇所
const int Calibration::NUM_OF_BLACK_CALIBRATION = 250; // ★キャリブレーション演習修正箇所
const int Calibration::NUM_OF_WHITE_CALIBRATION = 250; // ★キャリブレーション演習修正箇所
// const int Calibration::NUM_OF_GYRO_CALIBRATION =  1; // ★キャリブレーション演習修正箇所
// const int Calibration::NUM_OF_BLACK_CALIBRATION = 1; // ★キャリブレーション演習修正箇所
// const int Calibration::NUM_OF_WHITE_CALIBRATION = 1; // ★キャリブレーション演習修正箇所
